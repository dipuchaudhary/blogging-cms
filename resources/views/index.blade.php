            ...
            <div class="col-lg-8">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                    ...
                    <div class="post-thumb">
                        <img src="{{asset('storage/'.$post->featured_img)}}" alt="seo">
                        <div class="overlay"></div>
                        <a href="{{asset('storage/'.$post->featured_img)}}" class="link-image js-zoom-image">
            ...
            @foreach($second_posts as $second_post)
                <div class="col-lg-6">
                    <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{asset('storage/'.$second_post->featured_img)}}" alt="seo">
                            <div class="overlay"></div>
                            <a href="{{asset('storage/'.$second_post->featured_img)}}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="#" class="link-post">
                                <i class="seoicon-link-bold"></i>
            ...
            <div class="container">
                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <div class="case-item">
                                            <div class="case-item__thumb">
                                                <img src="{{asset('storage/'.$post->featured_img)}}" alt="our case">
                                            </div>
                    ...
                    <div class="offers">
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                               @foreach($vue->posts()->take(3)->get() as $post)
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <div class="case-item">
                                            <div class="case-item__thumb">
                                                <img src="{{asset('storage/'.$post->featured_img)}}" alt="our case">
